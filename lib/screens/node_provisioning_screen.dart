...
class _NodeProvisioningScreenState extends State<NodeProvisioningScreen> {
  ...
  // Mock / Discovered nearby devices
  final List<Map<String, dynamic>> _discoveredNodes = [
    {
      'name': 'BeeWare-Node-001',
      'mac': '24:6F:28:B4:8A:1C',
      'rssi': -58,
      'battery': 92,
      'firmware': 'v1.2.0',
    },
    {
      'name': 'BeeWare-Node-002',
      'mac': '24:6F:28:B4:9C:3E',
      'rssi': -74,
      'battery': 85,
      'firmware': 'v1.2.0',
    },
    {
      'name': 'ESP32-SmartConfig-Setup',
      'mac': '30:AE:A4:C7:11:F2',
      'rssi': -62,
      'battery': 100,
      'firmware': 'v1.2.0',
    },
  ...
  final TextEditingController _hiveNameController = TextEditingController(text: 'Hive 5 - New Apiary');
  final TextEditingController _ssidController = TextEditingController(text: 'MyHome_WiFi_2.4G');
  final TextEditingController _passwordController = TextEditingController();
  final TextEditingController _notesController = TextEditingController(text: 'Installed on migratory stand');
          ...
          child: Column(
            children: [
              Container(
                ...
                child: const Icon(Icons.bluetooth_searching, size: 38, color: Colors.black),
              ),
              const SizedBox(height: 16),
              Text(
                _isScanning ? 'Scanning for Nearby BeeWare Nodes...' : 'Scan Complete',
                style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Colors.black),
              ),
              const SizedBox(height: 4),
              const Text(
                'Ensure ESP32 node is powered on with INMP441 & DHT22 attached.',
              ...
              OutlinedButton.icon(
                ...
                label: const Text('Re-scan', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                onPressed: _startScanTimer,
              ),
            ],
          ),
        ),
